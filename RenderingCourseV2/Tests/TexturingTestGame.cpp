...
void TexturingTestGame::BuildTestScene()
{
	...
	FloorMeshComponent->AlbedoTexturePath = "G:/RenderingCourseV2/InputResources/Textures/TestTexture.png";
	...
	for (int ActorIndex = 0; ActorIndex < 5; ++ActorIndex)
	{
		...
		MeshComponent->AlbedoTexturePath = "G:/RenderingCourseV2/InputResources/Textures/TestTexture.png";
		...
		if (ActorIndex >= 3)
		{
			MeshComponent->NormalTexturePath = "G:/RenderingCourseV2/InputResources/Textures/TestTexture.png";
		}
